				...
				<div class="container">
					...
					<div class="row fullscreen d-flex align-items-center justify-content-start">
						...
						<div class="banner-content col-lg-12 text-center">
							...
							<button type="button"  class="primary-btn text-uppercase btn-float-left" data-toggle="modal" data-target="#myModal"> Experts Login </button>
							<button type="button" class="primary-btn text-uppercase btn-center" data-toggle="modal" data-target="#myModal"> Officer Login </button>
						
						
							
							<button type="button" class="primary-btn text-uppercase btn-float-right" data-toggle="modal" data-target="#myModal"> Admin Login </button>							
