...
<!DOCTYPE html>
	...
	<head>
	<link href="https://allfont.net/allfont.css?fonts=a_lcdnovaobl" rel="stylesheet" type="text/css" />
		...
		<body>
			...
			<section class="banner-area relative" id="home">
				...
				<div class="container">
					...
					<div class="row fullscreen d-flex align-items-center justify-content-start welcome">
						<h3 style="color: white; text-shadow: 1px 1px 2px black, 0 0 45px green, 0 0 45px darkgreen; font-size:100px;" class="text-white">
				<?php echo "WELCOME "; echo strtoupper($_SESSION['name']); ?> </h3>
